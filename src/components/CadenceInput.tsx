...
const INTERVAL_OPTIONS_SHORT = [
  { value: "s", label: "Clicks/sec" },
  { value: "m", label: "Clicks/min" },
  { value: "h", label: "Clicks/hour" },
  { value: "d", label: "Clicks/day" },
] as const;
        ...
        {settings.rateInputMode === "rate" ? (
          <div className="simple-cadence-row">
            ...
            <AdvDropdown
              ...
              options={INTERVAL_OPTIONS_SHORT}
              allowWindowOverflow
              onChange={(value) =>
