...
fn default_speed_variation_curve() -> String {
    "gaussian".to_string()
}
...
pub struct ClickerSettings {
    ...
    #[serde(default = "default_speed_variation_curve")]
    pub speed_variation_curve: String,
    ...
    #[serde(default)]
    pub foreground_lock_enabled: bool,
    #[serde(default)]
    pub foreground_lock_title: String,
...
impl Default for ClickerSettings {
    fn default() -> Self {
        Self {
            ...
            speed_variation_curve: "gaussian".to_string(),
