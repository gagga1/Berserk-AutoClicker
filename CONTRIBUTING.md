# Contributing to Berserk Auto Clicker

Thanks for helping improve Berserk Auto Clicker.

## Project scope

- Berserk Auto Clicker is a Windows-first desktop app built with Tauri 2, Rust, React, and TypeScript.
